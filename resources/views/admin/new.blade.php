    ...
    <section class="section dashboard">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" method="POST" action="{{ route('admin.create') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" min="1" class="form-control" value="{{ old('price') }}"
                            name="price" id="price" oninput="getChange('price')">
                        @if ($errors->get('price'))
                            <small class="mb-0 ms-2 text-danger">
                                {{ $errors->get('price')[0] }}
                            </small>
